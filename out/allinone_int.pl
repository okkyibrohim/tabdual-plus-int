...
:- table externally_inhibited_ab/3 as intern.
...
not_drug_active(C2,D2,K2,L2) :- 
    (intern_term([C2,D2],[I2,J2]),drug_active_star_1(I2,J2,K2,L2)).

externally_induced_ab(M2,N2,O2) :- 
    drug_active(M2,N2,[],O2).
:- table externally_induced_ab/3 as intern.
...
not_inactive(I3,J3,Q3,V3) :- 
    (intern_term([I3,J3],[O3,P3]),inactive_star_1(O3,P3,Q3,R3),intern_term([I3,J3],[T3,U3]),inactive_star_2(T3,U3,R3,V3)).

normally_inhibited_ab(W3,X3,Y3) :- 
    (not_absent(X3,[],Z3),inhibitor(X3,A4,Z3,B4),active(W3,A4,B4,Y3)).
:- table normally_inhibited_ab/3 as intern.
...
not_normally_inhibited(C4,D4,K4,L4) :- 
    (intern_term([C4,D4],[I4,J4]),normally_inhibited_star_1(I4,J4,K4,L4)).
...
:- table inhibited_ab/3 as intern.
...
not_inhibited(U4,V4,C5,H5) :- 
    (intern_term([U4,V4],[A5,B5]),inhibited_star_1(A5,B5,C5,D5),intern_term([U4,V4],[F5,G5]),inhibited_star_2(F5,G5,D5,H5)).

normally_active_ab(I5,J5,K5) :- 
    (not_absent(J5,[],L5),reaction(rct(M5,J5),L5,N5),active(I5,M5,N5,K5)).
:- table normally_active_ab/3 as intern.
...
not_active(H6,I6,P6,U6) :- 
    (intern_term([H6,I6],[N6,O6]),active_star_1(N6,O6,P6,Q6),intern_term([H6,I6],[S6,T6]),active_star_2(S6,T6,Q6,U6)).
